...
const BlogCategoryList = ({
  store,
  // , setAddBlog, setEditBlog, setTempBlog
}) => {
  const [resultType, setResultType] = useState("Categories");
  ...
  useEffect(async () => {
    if (resultType === "posts") {
      await getBlogs(setBlogs, store.token);
    } else if (resultType === "Categories") {
      await getBlogCategories(setBlogCategories, store.token);
      // console.log(blogCategories);
    }
  }, [resultType, blogCategories]);
            ...
            >
              <div className="addCategoryContainer">
                <div className="addFeaturedAssestsContainer">
                  <div className="confirmationModalHeading">Add Category</div>
                  <div
...
export default connect(mapStateToProps)(BlogCategoryList);
